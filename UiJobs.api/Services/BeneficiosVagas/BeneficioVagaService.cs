...
namespace UijobsApi.Services.BeneficiosVagas
{
    public class BeneficioVagaService : IBeneficioVagaService
    {
        ...
        public async Task<List<BeneficioVaga>> GetBeneficioVagaByIdAsync(int id)
        {
            List<BeneficioVaga> beneficioVaga = await _beneficioVagaRepository.GetAllBeneficioByID(id);
